        ...
        public IActionResult Technician(string filterby, bool? des)
        {
            ...
            switch (filterby)
            {
                ...
                case "prodname":
                    if (des == true)
                    {
                        Results = _context.Tickets.OrderByDescending(x => x.Car).ToList();
                        break;
                    }
                    else
                    {
                        Results = _context.Tickets.OrderBy(x => x.Car).ToList();
                        break;
                    }
                case "prodprice":
                    if (des == true)
                    {
                        Results = _context.Tickets.OrderByDescending(x => x.Reservation).ToList();
                        break;
                    }
                    else
                    {
                        Results = _context.Tickets.OrderBy(x => x.Reservation).ToList();
                        break;
                    }
                case "prodtype":
                    if (des == true)
